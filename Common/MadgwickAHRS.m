    ...
    methods (Access = public)
        function obj = MadgwickAHRS(varargin)
            for i = 1:2:nargin
                ...
                elseif  strcmp(varargin{i}, 'GyroBias'), obj.bias = varargin{i+1};
        ...
        function obj = Update(obj, Gyroscope, Accelerometer, Magnetometer)
            ...
            betak(1) = betakm(1) + obj.Zeta * g_err(2) * obj.SamplePeriod;
            betak(2) = betakm(2) + obj.Zeta * g_err(3) * obj.SamplePeriod;
            betak(3) = betakm(3) + obj.Zeta * g_err(1) * obj.SamplePeriod;
            Gyroscope = Gyroscope - betak;
